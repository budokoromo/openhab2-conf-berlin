...
'use strict';
    ...
    function IconService($http, $q, $filter) {
        ...
        var iconsets = [
            ...
            { id: 'knx', name: 'Builtin: knx', type: 'builtin', colorize: true },
            ...
            { id: 'knx-user-forum-a-e', name: 'Builtin: knx-user-forum-a-e', type: 'builtin', colorize: true },
            { id: 'knx-user-forum-f-m', name: 'Builtin: knx-user-forum-f-m', type: 'builtin', colorize: true },
            { id: 'knx-user-forum-n-z', name: 'Builtin: knx-user-forum-n-z', type: 'builtin', colorize: true },
